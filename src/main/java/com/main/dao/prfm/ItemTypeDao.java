...
public interface ItemTypeDao {
	 ...
	 * @return 对象集
	 */
	List<ItemType> get(Map<String, Object> map);
	 ...
	 * @return 对象集
	 */
	List<ItemType> getPage(Map<String, Object> map);
	 ...
	 * @return 对象集
	 */
	List<ItemType> getAll(@Param("companyid")String companyid);
	 ...
	 * @return 对象
	 */
    ItemType selectBypid(Map<String,Object> map);
