 ...
 */
public interface DeptNormKouFenDao {
	 ...
	 * @return 对象集
	 */
	List<DeptNormKouFen> get(Map<String, Object> map);
	 ...
	 * @return 对象集
	 */
	List<DeptNormKouFen> getPage(Map<String, Object> map);
	 ...
	 * @return
	 */
	List<DeptNormKouFenResult> getPageJoinDept(Map<String, Object> map); 
	Map<String,Object> getCountJoinDept(Map<String, Object> map);
	 ...
	 * @return
	 */
	List<DeptNormKouFenResult> getPageJoinUser(Map<String, Object> map); 
	Map<String,Object> getCountJoinUser(Map<String, Object> map);
	 ...
	 * @return 对象集
	 */
	List<DeptNormKouFen> getAll(@Param("companyid")String companyid);
	 ...
	 * @return 对象
	 */
    DeptNormKouFen selectBykid(Map<String,Object> map);
