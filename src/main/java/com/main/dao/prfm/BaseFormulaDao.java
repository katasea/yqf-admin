 ...
 */
public interface BaseFormulaDao {
	 ...
	 * @return 对象集
	 */
	List<BaseFormula> get(Map<String, Object> map);
	 ...
	 * @return 对象集
	 */
	List<BaseFormula> getPage(Map<String, Object> map);
	 ...
	 * @return 对象集
	 */
	List<BaseFormula> getAll(@Param("companyid")String companyid);
	 ...
	 * @return 对象
	 */
    BaseFormula selectByname(Map<String,Object> map);
