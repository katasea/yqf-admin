 ...
 */
public interface BaseDic4ListDao {
	 ...
	 * @return 对象集
	 */
	List<BaseDic4List> get(Map<String, Object> map);
	 ...
	 * @return 对象集
	 */
	List<BaseDic4List> getPage(Map<String, Object> map);
	 ...
	 * @return 对象集
	 */
	List<BaseDic4List> getAll(@Param("companyid")String companyid);
	 ...
	 * @return 对象
	 */
    BaseDic4List selectBytype(Map<String,Object> map);
