 ...
 */
public interface MidDataDicParentDao {
	 ...
	 * @return 对象集
	 */
	List<MidDataDicParent> get(Map<String, Object> map);
	 ...
	 * @return 对象集
	 */
	List<MidDataDicParent> getPage(Map<String, Object> map);
	 ...
	 * @return 对象集
	 */
	List<MidDataDicParent> getAll(@Param("companyid")String companyid);
	 ...
	 * @return 对象
	 */
    MidDataDicParent selectByid(Map<String,Object> map);
