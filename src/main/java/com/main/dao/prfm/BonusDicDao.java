...
public interface BonusDicDao {
	 ...
	 * @return 对象集
	 */
	List<BonusDic> get(Map<String, Object> map);
	 ...
	 * @return 对象集
	 */
	List<BonusDic> getPage(Map<String, Object> map);
	 ...
	 * @return 对象集
	 */
	List<BonusDic> getAll(@Param("companyid")String companyid);
	 ...
	 * @return 对象
	 */
    BonusDic selectBybh(Map<String,Object> map);
	 ...
	 * 拷贝上年记录
	 */
    void copyLastYear(Map<String,String> map);
