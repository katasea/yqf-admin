...
public interface KaoHeBiLiDao {
	 ...
	 * @return 对象集
	 */
	List<KaoHeBiLi> get(Map<String, Object> map);
	 ...
	 * @return 对象集
	 */
	List<KaoHeBiLiResult> getPage(Map<String, Object> map);
	 ...
	 * @return 对象集
	 */
	List<KaoHeBiLi> getAll(@Param("companyid")String companyid);
	 ...
	 * @return 对象
	 */
    KaoHeBiLi selectBykid(Map<String,Object> map);
