...
public interface ItemTypeService {
	 ...
	 * @return 部门对象
	 */
  	ItemType selectBypid(String id);
    /**
	 * 获取树
	 *
	 * @param keyword 关键检索词
	 ...
	 * @return 对象集
	 */
  	List<ItemType> get(String keyword, String node, Bridge bridge, String start, String limit);
    /**
	 * 获取当前条件下的对象数量
	 *
	 * @param keyword 关键检索词
	 ...
	 * @return 状态对象
	 */
	StateInfo edit(String code, ItemType itemType, Bridge bridge);
    /**
	 * 新增对象
	 *
	 * @param parentId 父节点信息
	 ...
	 * @return 状态对象
	 */
	StateInfo add(String parentId,ItemType itemType, Bridge bridge);
    /**
