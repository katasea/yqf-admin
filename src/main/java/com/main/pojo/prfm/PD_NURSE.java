 ...
 * 护士工分结果表
 * */
@Table(name="PD_NURSE@year")
public class PD_NURSE implements Serializable {

    private static final long serialVersionUID = -8680069344804584927L;
    @Column(flag = "primary")
    ...
    private String nurse;//护士系数

    @Column(type = "decimal(18,6)")
    private String orinurse;//护士原始系数

    @Column(type = "decimal(18,6)")
    private String adjnurse;//护士调整系数
    ...
    public String getOrinurse() {
        return orinurse;
    }

    public void setOrinurse(String orinurse) {
        this.orinurse = orinurse;
    }

    public String getAdjnurse() {
        return adjnurse;
    }

    public void setAdjnurse(String adjnurse) {
