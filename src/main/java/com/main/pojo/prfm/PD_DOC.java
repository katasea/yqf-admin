 ...
 *  医生工分结果表
 * */
@Table(name="PD_DOC@year")
public class PD_DOC implements Serializable {

    private static final long serialVersionUID = -4192267657058640113L;
    @Column(flag = "primary")
    ...
    private String doc;//医生系数

    @Column(type = "decimal(18,6)")
    private String oridoc;//医生原始系数

    @Column(type = "decimal(18,6)")
    private String adjdoc;//医生调整系数
    ...
    public String getAdjdoc() {
        return adjdoc;
    }

    public void setAdjdoc(String adjdoc) {
        this.adjdoc = adjdoc;
    }
