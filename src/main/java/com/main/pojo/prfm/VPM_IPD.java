 ...
 * 住院收费明细
 */
@Table(name = "VPM_IPD@YEAR")
public class VPM_IPD implements Serializable {

	private static final long serialVersionUID = -1959430114010508570L;
	...
	@Column
	private String opt_doc;//手术医生编号
	@Column
	private String opt_doc_name;//手术医生名称
	@Column
	private String a1doc;//一助医生编号
	@Column
	private String a1doc_name;//一助医生名称
	@Column
	private String a2doc;//二助医生编号
	@Column
	private String a2doc_name;//二助医生名称
	@Column
	private String a3doc;//三助医生编号
	@Column
	private String a3doc_name;//三助医生名称
	@Column
	...
	public String getOpt_doc() {
		return opt_doc;
	}

	public void setOpt_doc(String opt_doc) {
		this.opt_doc = opt_doc;
	}

	public String getOpt_doc_name() {
		return opt_doc_name;
	}

	public void setOpt_doc_name(String opt_doc_name) {
		this.opt_doc_name = opt_doc_name;
	}

	public String getA1doc() {
		return a1doc;
	}

	public void setA1doc(String a1doc) {
		this.a1doc = a1doc;
	}

	public String getA1doc_name() {
		return a1doc_name;
	}

	public void setA1doc_name(String a1doc_name) {
		this.a1doc_name = a1doc_name;
	}

	public String getA2doc() {
		return a2doc;
	}

	public void setA2doc(String a2doc) {
		this.a2doc = a2doc;
	}

	public String getA2doc_name() {
		return a2doc_name;
	}

	public void setA2doc_name(String a2doc_name) {
		this.a2doc_name = a2doc_name;
	}

	public String getA3doc() {
		return a3doc;
	}

	public void setA3doc(String a3doc) {
		this.a3doc = a3doc;
	}

	public String getA3doc_name() {
		return a3doc_name;
	}

	public void setA3doc_name(String a3doc_name) {
		this.a3doc_name = a3doc_name;
	}
