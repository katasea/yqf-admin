 ...
 * 医技工分结果表
 * */
@Table(name="PD_OPERATOR@year")
public class PD_OPERATOR implements Serializable {

    private static final long serialVersionUID = 1846369565740654074L;
    @Column(flag = "primary")
    ...
    private String operator;//医技系数

    @Column(type = "decimal(18,6)")
    private String orioperator;//医技原始系数

    @Column(type = "decimal(18,6)")
    private String adjoperator;//医技调整系数
    ...
    public void setOrioperator(String orioperator) {
