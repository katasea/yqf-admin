 ...
 * 诊断工分结果表
 * */
@Table(name="PD_DIAGNOSIS@year")
public class PD_DIAGNOSIS implements Serializable {

    private static final long serialVersionUID = 5603573379450592085L;
    ...
    private String diagnosis;//诊断系数

    @Column(type = "decimal(18,6)")
    private String oridiagnosis;//诊断原始系数

    @Column(type = "decimal(18,6)")
    private String adjdiagnosis;//诊断调整系数
    ...
    public String getOridiagnosis() {
        return oridiagnosis;
    }

    public void setOridiagnosis(String oridiagnosis) {
        this.oridiagnosis = oridiagnosis;
    }

    public String getAdjdiagnosis() {
        return adjdiagnosis;
    }

    public void setAdjdiagnosis(String adjdiagnosis) {
