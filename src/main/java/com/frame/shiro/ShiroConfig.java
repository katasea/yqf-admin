...
//        }
	...
	public org.springframework.data.redis.cache.RedisCacheManager cacheManager(RedisConnectionFactory connectionFactory) {
		org.springframework.data.redis.cache.RedisCacheManager redisCacheManager =  new org.springframework.data.redis.cache.RedisCacheManager(redisTemplate(connectionFactory));
		return redisCacheManager;
	}
