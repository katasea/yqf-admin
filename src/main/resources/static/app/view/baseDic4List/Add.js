...
Ext.define('MyApp.view.baseDic4List.Add', {
    extend: 'Ext.form.Panel',
    xtype: 'baseDic4ListAdd',
    autoScroll:true,
    requires: [
    	'*',
        'Ext.ux.DataTip'
    ...
    items: [
		    ...
		    {
		        fieldLabel: '备用信息',xtype:'textfield',
		        id:'reverse',name: 'reverse',
		        allowBlank: false,afterLabelTextTpl: required,tooltip: '请输入【必填项】【备用信息】'
		    }    ],
