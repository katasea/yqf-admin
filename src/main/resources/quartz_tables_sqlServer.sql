...
--#本项目开启quatz的方法如下： 1  去掉 pom 里面的引入包注释，检索quatz
--# 2 去掉 com.config.SchedulerConfig注释
--# 3 去掉 com.main.controller.platform.JobController 以及对应的service impl 注释。
--# 4 使用样例查看 DeptInfoServiceImpl
GO
